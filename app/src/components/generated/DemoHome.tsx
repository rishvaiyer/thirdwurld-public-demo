...
// Counts and districts are not repeated here: the city draws both, and stating
// them twice is what the section was being cleared of in the first place.
            ...
            <div className="relative mx-auto w-full max-w-6xl px-5 py-16 sm:px-8 lg:py-20">
              <Reveal>
                ...
                <p className="mt-5 max-w-[68ch] text-[16px] leading-[1.72] text-[#d9d2c4]">
                  This is the source that runs the world, drawn from the repository itself. One building is one tracked file. Height is lines of code, colour is language, lit windows are how often that file has changed, and districts are the top-level folders. Filenames and sizes only, never contents.
                </p>
              </Reveal>
