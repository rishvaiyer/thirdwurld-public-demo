        ...
        <header className="w-full border-b border-[color:var(--tw-line)]">
          <div className="mx-auto flex w-full max-w-6xl flex-col gap-3 px-5 py-4 sm:px-8 lg:flex-row lg:items-center lg:justify-between lg:gap-6">
            ...
            <nav aria-label="Primary" className="flex flex-wrap items-center gap-x-4 gap-y-1.5">
              ...
              <a href="../day/" className="tw-mono group relative whitespace-nowrap py-1 text-[9.5px] uppercase tracking-[0.13em] text-[#f1eadb] transition-colors duration-300">
                A Day
              ...
              <a href="../world/#preview" className="tw-mono group relative whitespace-nowrap py-1 text-[9.5px] uppercase tracking-[0.13em] text-[#b7b3a8] hover:text-[#f1eadb] transition-colors duration-300">
                Preview
                <span className="absolute inset-x-0 -bottom-0.5 h-px origin-left scale-x-0 group-hover:scale-x-100 bg-[#d8a85f] transition-transform duration-400" />
              </a>
        ...
        <section className="w-full flex-1">
          <div className="mx-auto w-full max-w-5xl px-5 py-14 sm:px-8">
            ...
            <div className="mt-10 flex flex-wrap gap-x-8 gap-y-3">
              {[['See the codebase ↗', '../world/#technology'], ['Meet the residents ↗', '../world/#residents'], ['Try one resident ↗', '../try/']].map(([l, href]) => <a key={l} href={href} className="text-[14.5px] text-[#d9d2c4] transition-colors duration-300 hover:text-[#f5d79d]">
                  {l}
                </a>)}
            </div>
          </div>
