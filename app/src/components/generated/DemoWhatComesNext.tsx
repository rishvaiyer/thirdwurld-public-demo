        ...
        <section className="w-full">
          <div className="mx-auto w-full max-w-5xl px-5 py-16 sm:px-8">
            ...
            <div className="mt-9 flex flex-wrap gap-x-8 gap-y-3">
              {[['See the human member flow ↗', '../member/'], ['Try a bounded resident capsule ↗', '../try/']].map(([t, href]) => <a key={t} href={href} className="text-[15px] text-[#d9d2c4] transition-colors duration-300 hover:text-[#f5d79d]">
                  {t}
                </a>)}
            </div>
          </div>
