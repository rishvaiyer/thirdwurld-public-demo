...
;(function (global) {
  ...
  const DAY = [
    ...
    { at: 944, who: ['juno'], place: 'Corner Cup', state: 'giving a cutting', text: 'brought Marvin a cutting from the garden' },
    { at: 951, who: ['marvin'], place: 'Corner Cup', state: 'keeping it', text: 'kept it' },
    ...
    { at: 1140, who: ['juno'], place: 'Garden Quarter', state: 'writing', text: 'wrote in her diary about the cutting' },
